public class ConsoleColors
{
    ...
    // Faint
    public static final String BLACK_FAINT = "\033[2;30m";  // BLACK
    public static final String RED_FAINT = "\033[2;31m";    // RED
    public static final String GREEN_FAINT = "\033[2;32m";  // GREEN
    public static final String YELLOW_FAINT = "\033[2;33m"; // YELLOW
    public static final String BLUE_FAINT = "\033[2;34m";   // BLUE
    public static final String PURPLE_FAINT = "\033[2;35m"; // PURPLE
    public static final String CYAN_FAINT = "\033[2;36m";   // CYAN
    public static final String WHITE_FAINT = "\033[2;37m";  // WHITE
